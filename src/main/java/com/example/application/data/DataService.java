...
//  public static List<Persona> getPeople() {
//    List<Persona> people = Arrays.asList(getItems(Persona[].class, "people.json"));
...
//  public static List<Persona> getPeople(int count) {
//    return getPeople().subList(0, count);
//  }
//
//  public static List<Persona> getPeople(int count, Integer managerId) {
//    List<Persona> people = getPeople(managerId);
